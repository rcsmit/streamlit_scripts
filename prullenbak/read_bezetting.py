...
def make_booking_table(year):
    ...
    print (df)
    print (f"Number of days total : {df['number_of_days'].sum()}")
    print (f"Number of days min : {df['number_of_days'].min()}")
    print (f"Number of days max : {df['number_of_days'].max()}")
    print (f"Number of days average : {df['number_of_days'].mean()}")
